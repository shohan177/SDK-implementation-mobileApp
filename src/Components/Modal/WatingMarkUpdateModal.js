...
// create a component
const WaitingMarkUpdateModal = ({uploadDone, setUploadDone}) => {
  return (
    <>
      <Modal
        visible={uploadDone}
          ...
          <View style={styles.warning_modal}>
            <View style={styles.topCard}>
              ...
              <View style={styles.topCardChild}>
                ...
                <Text style={styles.text}>Waiting for superstar mark update</Text>
              </View>
            </View>
          </View>
        </View>
...
export default WaitingMarkUpdateModal;
